...
async def start_server():
    handler = ForwardingHandler(
        relay_host="smtp.gmail.com",         # Outlook SMTP server
        relay_port=587,                        # SMTP port
        relay_user="bluesparrow.paritosh.9@gmail.com",  # Your Outlook email
        relay_password="Vikrant@12345"   # Your Outlook App Password
    )
    controller = Controller(handler, hostname="127.0.0.1", port=1028)  # Using port 1025 for local SMTP server
